                    ...
                    <div className="charts-display">
                        <div className="chart-container">
                            <p className="chart-txt">
                                Class Mean:&nbsp;{expectedGradeMean}&nbsp;&nbsp;
                                Rice Mean: 1.34
                                <br />
                                Responses:&nbsp;{expectedGradeRes}
                            </p>
                            <Chart dataSource={expectedGrade} height={"100px"}>
                                <CommonAnnotationSettings
                                    type="text"
                                    series="Value"
                                    allowDragging={false}
                                ...
                                <Size height={270} width={335} />
                            </Chart>
                        </div>
                        <div className="chart-container">
                            <p className="chart-txt">
                                Class Mean:&nbsp;{expectedGradePFMean}
                                &nbsp;&nbsp; Rice Mean: 1.59
                                <br />
                                Responses:&nbsp;{expectedGradePFRes}
                            </p>
                            <Chart
                        ...
                        <div className="chart-container">
                            <p className="chart-txt">
                                Class Mean:&nbsp;{organizationMean}&nbsp;&nbsp;
                                Rice Mean: 1.73
                                <br />
                                Responses:&nbsp;{organizationRes}
                            </p>
                            <Chart dataSource={organization} height={"100px"}>
                                <CommonAnnotationSettings
                                    type="text"
                                    series="Value"
                                    allowDragging={false}
                        ...
                        <div className="chart-container">
                            <p className="chart-txt">
                                Class Mean:&nbsp;{assignmentsMean}&nbsp;&nbsp;
                                Rice Mean: 1.75
                                <br />
                                Responses:&nbsp;{assignmentsRes}
                            </p>
                            <Chart dataSource={assignments} height={"100px"}>
                                <CommonAnnotationSettings
                                    type="text"
                                    series="Value"
                                    allowDragging={false}
                        ...
                        <div className="chart-container">
                            <p className="chart-txt">
                                Class Mean:&nbsp;{qualityMean}&nbsp;&nbsp; Rice
                                Mean: 1.75
                                <br />
                                Responses:&nbsp;{qualityRes}
                            </p>
                            <Chart dataSource={quality} height={"100px"}>
                                <CommonAnnotationSettings
                                    type="text"
                                    series="Value"
                                    allowDragging={false}
                        ...
                        <div className="chart-container">
                            <p className="chart-txt">
                                Class Mean:&nbsp;{challengeMean}&nbsp;&nbsp;
                                Rice Mean: 1.73
                                <br />
                                Responses:&nbsp;{challengeRes}
                            </p>
                            <Chart dataSource={challenge} height={"100px"}>
                                <CommonAnnotationSettings
                                    type="text"
                                    series="Value"
                                    allowDragging={false}
                        ...
                        <div className="chart-container">
                            <p className="chart-txt">
                                Class Mean:&nbsp;{whyTakingMean}&nbsp;&nbsp;
                                Rice Mean: 2.18
                                <br />
                                Responses:&nbsp;{whyTakingRes}
                            </p>
                            <Chart dataSource={whyTaking} height={"100px"}>
                                <CommonAnnotationSettings
                                    type="text"
                                    series="Value"
                                    allowDragging={false}
                        ...
                        <div className="chart-container">
                            <p className="chart-txt">
                                Class Mean:&nbsp;{workloadMean}&nbsp;&nbsp; Rice
                                Mean: 2.78
                                <br />
                                Responses:&nbsp;{workloadRes}
                            </p>
                            <Chart dataSource={workload} height={"100px"}>
                                <CommonAnnotationSettings
                                    type="text"
                                    series="Value"
                                    allowDragging={false}
